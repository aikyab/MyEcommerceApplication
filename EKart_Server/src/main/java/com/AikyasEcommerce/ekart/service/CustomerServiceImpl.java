...
import com.AikyasEcommerce.ekart.validator.CustomerValidator;
...
public class CustomerServiceImpl implements CustomerService{
	...
	public String registerNewCustomer(Customer customer) throws Exception {
		...
		Boolean phoneNumberAvailable = customerDAO.checkAvailabilityOfPhoneNumber(customer.getPhoneNo());
		if(emailAvailable){
	...
	public void updateProfile(Customer customer) throws Exception {
		...
		newCustomer=customerDAO.getCustomerByPhoneNumber(customer.getPhoneNo());
		if(newCustomer==null){
