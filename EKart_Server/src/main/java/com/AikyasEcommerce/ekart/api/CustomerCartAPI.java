...
import com.AikyasEcommerce.ekart.service.CustomerCartService;
...
public class CustomerCartAPI {
	...
	@PostMapping(value = "deleteProductFromCart/{customerEmailId:.+}/{cartId}")
	public ResponseEntity<String> deleteProductFromCart(@PathVariable("customerEmailId") String customerEmailId, @PathVariable String cartId) throws Exception{
